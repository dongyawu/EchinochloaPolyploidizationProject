...
#######3 pal2nal aligned protein to CDS ##### 
  system(qq(perl ../pal2nal.pl ./$orthpair.tmpdir/$pair.pep.mafft ./$orthpair.tmpdir/$pair.cds -nogap -output fasta > ./$orthpair.tmpdir/$pair.pal2CDS));
    
#######4 aligned CDS --> axt format
    system(qq(perl ../onefasta2axt.pl ./$orthpair.tmpdir/$pair.pal2CDS));
