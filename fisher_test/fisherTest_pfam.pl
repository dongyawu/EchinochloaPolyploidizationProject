...
while (<IN>){
	chomp;
	my ($pfam, $G1_c1, $G1_c2, $G2_c1, $G2_c2)=split /\t/,$_;
	#print $_."\n";
	system(qq(Rscript /public2/wudy/EC/script/fisher_test.R $G1_c1 $G1_c2 $G2_c1 $G2_c2 >> $count.log ));
	#print $_."\n";
	#print $pval."\n";
